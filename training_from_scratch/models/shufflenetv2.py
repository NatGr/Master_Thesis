...
def build_shufflenetv2(inputs, regularizer, blocks_per_subnet=(4, 4, 4), num_classes=10,
                       channels_per_subnet=(32, 64, 128), se_factor=0):
    ...
    for i in range(3):
        ...
        for _ in range(blocks_per_subnet[i] - 1):
            x = shufflenetv2_block(x, channels_per_subnet[i], regularizer, se_factor=se_factor)
...
def shufflenetv2_block(x_in, ch_out, regularizer, strides=1, se_factor=0):
