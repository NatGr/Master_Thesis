...
def main():
    ...
    if args.data == "cifar10":
        ...
        train_set = datasets.CIFAR10('~/Documents/CIFAR-10', train=True, download=True,
        ...
        val_set = datasets.CIFAR10('~/Documents/CIFAR-10', train=False,
                                   transform=transforms.Compose([
                                       transforms.ToTensor(),
                                       norm_transform,
                                   ]))
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        target = target.cuda(non_blocking=True)  # was initially target.cuda(async=True) which resulted in syntaxerror, dunno why
